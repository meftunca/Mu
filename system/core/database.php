...
class database
{
    ...
    public function __construct()
    {
        ...
        {
            exit("DB error => ". "Can not connect to Database with PDO.<br><br>" . $e->getMessage());
        }
    ...
    public function insert($data = [])
    {
        ...
        if (is_null($this->table))
            exit('DB Hatası => '.'INSERT işlemi yapılacak tablo seçilmedi.');
    ...
    {
        if (is_null($this->table))
           exit('DB Hatası =>  '. 'UPDATE işlemi yapılacak tablo seçilmedi.');
    ...
    {
        if (is_null($this->table))
           exit('DB Hatası =>  '. 'DELETE işlemi yapılacak tablo seçilmedi.');
